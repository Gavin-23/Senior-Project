...
var map = {
	"../create-event/create-event.module": [
		"./src/app/create-event/create-event.module.ts",
		"create-event-create-event-module"
	],
	"../event-list/event-list.module": [
	...
	"./staff-login/staff-login.module": [
		"./src/app/staff-login/staff-login.module.ts",
		"staff-login-staff-login-module"
	],
	"./student-login/student-login.module": [
		"./src/app/student-login/student-login.module.ts",
		"student-login-student-login-module"
	],
	"./student/student-tabs/student-tabs.module": [
	...
	"src/app/student/view-calendar/view-calendar.module": [
		"./src/app/student/view-calendar/view-calendar.module.ts",
		"src-app-student-view-calendar-view-calendar-module"
	],
	"src/app/student/view-event/view-event.module": [
...
/* harmony import */ var _redirect_redirect_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./redirect/redirect.component */ "./src/app/redirect/redirect.component.ts");
...
var routes = [
    ...
    {
        path: 'sign-in',
        canActivate: [_redirect_redirect_component__WEBPACK_IMPORTED_MODULE_3__["RedirectComponent"]],
        component: _redirect_redirect_component__WEBPACK_IMPORTED_MODULE_3__["RedirectComponent"],
        data: {
...
/* harmony import */ var ionic2_calendar__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ionic2-calendar */ "./node_modules/ionic2-calendar/index.js");
...
/* harmony import */ var _redirect_redirect_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./redirect/redirect.component */ "./src/app/redirect/redirect.component.ts");
/* harmony import */ var _ionic_native_fcm_ngx__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @ionic-native/fcm/ngx */ "./node_modules/@ionic-native/fcm/ngx/index.js");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _redirect_redirect_component__WEBPACK_IMPORTED_MODULE_21__["RedirectComponent"]],
            entryComponents: [],
            imports: [
                ...
                ionic2_calendar__WEBPACK_IMPORTED_MODULE_17__["NgCalendarModule"],
            ...
            providers: [
                ...
                _ionic_native_fcm_ngx__WEBPACK_IMPORTED_MODULE_22__["FCM"],
...
var config = {
    ...
    databaseURL: "https://csla-0423.firebaseio.com",
    projectId: "csla-0423",
    storageBucket: "csla-0423.appspot.com",
    messagingSenderId: "643643065549",
    appId: "1:643643065549:web:7655600267e9f9bf"
};
...
/***/ "./src/app/redirect/redirect.component.scss":
/*!**************************************************!*\
  !*** ./src/app/redirect/redirect.component.scss ***!
  \**************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL3JlZGlyZWN0L3JlZGlyZWN0LmNvbXBvbmVudC5zY3NzIn0= */"
...
var RedirectComponent = /** @class */ (function () {
    function RedirectComponent(router, afAuth, http, alertController, afstore, user) {
        this.router = router;
        this.afAuth = afAuth;
        this.http = http;
    ...
    RedirectComponent.prototype.canActivate = function (next, state) {
        var _this = this;
        this.user.read_Student().subscribe(function (data) {
        ...
        this.user.read_Lecturer().subscribe(function (data) {
            _this.lecturer = data.map(function (e) {
                return {
                    id: e.payload.doc.id,
                    Account: e.payload.doc.data()['emailAddress']
                };
            });
            console.log(_this.lecturer);
        });
        if (state.url === '/sign-in') {
            ...
            return this.http.post("https://cors-anywhere.herokuapp.com/https://oauth.cmu.ac.th/v1/GetToken.aspx", params, httpOptions).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (data) {
                ...
                _this.http.get("https://misapi.cmu.ac.th/cmuitaccount/v1/api/cmuitaccount/basicinfo", {
                    ...
                    if (info.itaccounttype_id == 'StdAcc') {
                        ...
                        for (var _b = 0, _c = _this.lecturer; _b < _c.length; _b++) {
                            var user = _c[_b];
                            if (user.Account != info.cmuitaccount) {
                                _this.lecturerRegister(info.cmuitaccount);
                            }
                        }
                    }
                ...
                _this.router.navigate(['/student-tabs/view-event']);
                return data;
            }));
        }
        else {
    ...
    RedirectComponent.prototype.studentRegister = function (emailAddress, studentId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var password, res, error_1;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        password = "123456";
                        return [4 /*yield*/, this.afAuth.auth.createUserWithEmailAndPassword(emailAddress, password)];
                    case 1:
                        res = _a.sent();
    ...
    RedirectComponent.prototype.lecturerRegister = function (emailAddress) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var password, res, error_2;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
    ...
    RedirectComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./redirect.component.scss */ "./src/app/redirect/redirect.component.scss")]
        }),
...
/* harmony import */ var _angular_fire_auth_auth__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/fire/auth/auth */ "./node_modules/@angular/fire/auth/auth.js");
/* harmony import */ var firebase__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! firebase */ "./node_modules/firebase/dist/index.cjs.js");
/* harmony import */ var firebase__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(firebase__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _angular_fire_database_database__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/fire/database/database */ "./node_modules/@angular/fire/database/database.js");
...
var UserService = /** @class */ (function () {
    ...
    UserService.prototype.read_Student = function () {
        return this.firestore.collection('Students').snapshotChanges();
    };
    UserService.prototype.read_Lecturer = function () {
    ...
    UserService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"],
            _angular_fire_auth_auth__WEBPACK_IMPORTED_MODULE_3__["AngularFireAuth"],
            _angular_fire_database_database__WEBPACK_IMPORTED_MODULE_5__["AngularFireDatabase"]])
    ], UserService);
    return UserService;
}());
...
module.exports = __webpack_require__(/*! /Users/apple/Desktop/Senior-Project/src/main.ts */"./src/main.ts");
